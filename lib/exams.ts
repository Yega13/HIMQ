...
export const EXAMS: ExamMeta[] = [
  ...
  },
  {
    ...
    fullName: 'Armenian Unified State Exam · Physics',
    category: 'armenian',
    emoji: '⚛️',
    blurb: 'Required by most engineering and technical programmes. Mechanics, thermodynamics, electricity and optics.',
    sections: ['Mechanics', 'Thermodynamics & molecular physics', 'Electricity & magnetism', 'Optics & modern physics'],
    scoreLabel: 'Target score (0–20)',
    scoreHint: "Armenia's 20-point unified-exam scale",
    scorePlaceholder: '18',
    status: 'live',
  ...
  {
    id: 'unified-chemistry',
    name: 'Unified — Chemistry',
    fullName: 'Armenian Unified State Exam · Chemistry',
    category: 'armenian',
    emoji: '🧪',
    blurb: 'For chemistry, medicine, biotechnology and food-technology programmes.',
    sections: ['General chemistry', 'Inorganic chemistry', 'Organic chemistry', 'Calculations & problem solving'],
    scoreLabel: 'Target score (0–20)',
    scoreHint: "Armenia's 20-point unified-exam scale",
    scorePlaceholder: '18',
    status: 'live',
  },
  {
    ...
    fullName: 'Armenian Unified State Exam · Biology',
    category: 'armenian',
    emoji: '🧬',
    blurb: 'For medicine, biology, agriculture and health-science programmes.',
    sections: ['Cytology & botany', 'Zoology', 'Human anatomy & physiology', 'Genetics & evolution'],
    scoreLabel: 'Target score (0–20)',
    scoreHint: "Armenia's 20-point unified-exam scale",
    scorePlaceholder: '18',
    status: 'live',
  ...
  {
    id: 'unified-history',
    name: 'Unified — Armenian History',
    fullName: 'Armenian Unified State Exam · History of Armenia',
    category: 'armenian',
    emoji: '🏛️',
    blurb: 'Required by many humanities, law and international-relations programmes.',
    sections: ['Ancient Armenia', 'Medieval Armenia', 'Modern period', 'Contemporary Armenia'],
    scoreLabel: 'Target score (0–20)',
    scoreHint: "Armenia's 20-point unified-exam scale",
    scorePlaceholder: '18',
    status: 'live',
  ...
  {
    id: 'unified-russian',
    name: 'Unified — Russian',
    fullName: 'Armenian Unified State Exam · Russian Language',
    category: 'armenian',
    emoji: '🇷🇺',
    blurb: 'Accepted as the language requirement by many programmes, and required by some.',
    sections: ['Grammar & orthography', 'Vocabulary', 'Reading comprehension', 'Writing'],
    scoreLabel: 'Target score (0–20)',
    scoreHint: "Armenia's 20-point unified-exam scale",
    scorePlaceholder: '18',
    status: 'live',
  ...
  {
    id: 'unified-english',
    name: 'Unified — English',
    fullName: 'Armenian Unified State Exam · English (Foreign Language)',
    category: 'armenian',
    emoji: '🔤',
    blurb: 'The foreign-language unified exam. Grammar, vocabulary, reading and writing.',
    sections: ['Grammar', 'Vocabulary', 'Reading comprehension', 'Writing'],
    scoreLabel: 'Target score (0–20)',
    scoreHint: "Armenia's 20-point unified-exam scale",
    scorePlaceholder: '18',
    status: 'live',
  ...
  {
    id: 'unified-geography',
    name: 'Unified — Geography',
    fullName: 'Armenian Unified State Exam · Geography',
    category: 'armenian',
    emoji: '🌍',
    blurb: 'For geography, tourism, environmental and some economics programmes.',
    sections: ['Physical geography', 'Economic geography', 'Geography of Armenia', 'World geography'],
    scoreLabel: 'Target score (0–20)',
    scoreHint: "Armenia's 20-point unified-exam scale",
    scorePlaceholder: '18',
    status: 'live',
