...
- **OPEN DESIGN — exam lesson count (needs decision):** current plan prompt caps at 3–8 "fewest" lessons — WRONG for exam prep with months of runway. Founder wants 30–40 granular lessons sized to available days (easy 0.5d / medium 1d / hard 2–3d), level-aware, cover-everything-then-review. See discussion in chat 2026-07-17.
